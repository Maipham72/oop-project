test: tests.cpp cardPaymentTest.cpp DrinksTest.cpp cashPaymentTest.cpp MenuItemTest.cpp CartTest.cpp
	g++ -std=c++11 -Wall -Wextra -o test tests.cpp cardPaymentTest.cpp DrinksTest.cpp cashPaymentTest.cpp MenuItemTest.cpp CartTest.cpp
